...
if [ -d "$CODEX_HOME/skills/gstack/.git" ]; then
  INSTALL_TYPE="global-git"
  INSTALL_DIR="$CODEX_HOME/skills/gstack"
  ...
  INSTALL_DIR=".codex/skills/gstack"
elif [ -d "$CODEX_HOME/skills/gstack" ]; then
  INSTALL_TYPE="vendored-global"
  INSTALL_DIR="$CODEX_HOME/skills/gstack"
elif [ -d "$HOME/.claude/skills/gstack/.git" ]; then
  INSTALL_TYPE="legacy-global-git"
  INSTALL_DIR="$HOME/.claude/skills/gstack"
elif [ -d ".claude/skills/gstack/.git" ]; then
  INSTALL_TYPE="legacy-local-git"
  INSTALL_DIR=".claude/skills/gstack"
elif [ -d ".claude/skills/gstack" ]; then
  INSTALL_TYPE="legacy-vendored"
  INSTALL_DIR=".claude/skills/gstack"
elif [ -d "$HOME/.claude/skills/gstack" ]; then
  INSTALL_TYPE="legacy-vendored-global"
  INSTALL_DIR="$HOME/.claude/skills/gstack"
else
...
**For git installs** (global-git, local-git, legacy-global-git, legacy-local-git):
```bash
cd "$INSTALL_DIR"
...
**For vendored installs** (vendored, vendored-global, legacy-vendored, legacy-vendored-global):
```bash
