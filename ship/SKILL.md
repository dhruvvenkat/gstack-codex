...
1. Resolve the review skill directory, preferring Codex installs and falling back to legacy Claude installs:

```bash
_CODEX_HOME="${CODEX_HOME:-$HOME/.codex}"
_REVIEW_DIR=""
[ -d ".codex/skills/review" ] && _REVIEW_DIR=".codex/skills/review"
[ -z "$_REVIEW_DIR" ] && [ -d ".codex/skills/gstack/review" ] && _REVIEW_DIR=".codex/skills/gstack/review"
[ -z "$_REVIEW_DIR" ] && [ -d "$_CODEX_HOME/skills/review" ] && _REVIEW_DIR="$_CODEX_HOME/skills/review"
[ -z "$_REVIEW_DIR" ] && [ -d "$_CODEX_HOME/skills/gstack/review" ] && _REVIEW_DIR="$_CODEX_HOME/skills/gstack/review"
[ -z "$_REVIEW_DIR" ] && [ -d ".claude/skills/review" ] && _REVIEW_DIR=".claude/skills/review"
[ -z "$_REVIEW_DIR" ] && [ -d ".claude/skills/gstack/review" ] && _REVIEW_DIR=".claude/skills/gstack/review"
[ -z "$_REVIEW_DIR" ] && [ -d "$HOME/.claude/skills/review" ] && _REVIEW_DIR="$HOME/.claude/skills/review"
[ -z "$_REVIEW_DIR" ] && [ -d "$HOME/.claude/skills/gstack/review" ] && _REVIEW_DIR="$HOME/.claude/skills/gstack/review"
```

Read ``$_REVIEW_DIR/checklist.md``. If the file cannot be read, **STOP** and report the error.
...
Read ``$_REVIEW_DIR/greptile-triage.md`` and follow the fetch, filter, and classify steps.
