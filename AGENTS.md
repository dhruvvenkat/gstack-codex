...
│   └── skill-e2e.test.ts         # Tier 2: E2E via Codex -p (~$3.85/run)
...
1. Push your branch
2. Fetch and reset in the skill directory: `cd ~/.Codex/skills/gstack && git fetch origin && git reset --hard origin/main`
